...
function CampusPlan() {
  return <figure className="campus-plan"><div className="campus-plan-title"><div><p className="section-eyebrow">Top-down schematic · not terrain scale</p><h3>Phase 0 home campus</h3><p>Rocky Desert western basin · X -2,633 · Y -267</p><p>Required in Phase 0: 307 foundations</p></div><span>54 × 38 foundation reserve</span></div>
    <svg viewBox="0 0 900 650" role="img" aria-labelledby="campus-title campus-desc">
      <title id="campus-title">Top-down plan for the Rocky Desert home campus</title><desc id="campus-desc">A raised campus with an eleven by eleven foundation Space Elevator plaza around its seven by seven machine footprint, HUB and MAM, a twelve by eight foundation black-start power building, a reserved Phase 1 component quarter, truck court, utility spine and terminal boulevard.</desc>
      ...
      <rect x="274" y="72" width="176" height="176" className="plan-plaza" /><rect x="306" y="104" width="112" height="112" className="plan-elevator-footprint" /><text x="362" y="148" textAnchor="middle" className="svg-title">SPACE ELEVATOR</text><text x="362" y="172" textAnchor="middle" className="svg-label">7 × 7 MACHINE FOOTPRINT</text><text x="362" y="196" textAnchor="middle" className="svg-note">11 × 11 plaza · 121 foundations</text><path d="M274 52h176M274 46v12M450 46v12" className="dimension-line" /><text x="362" y="44" textAnchor="middle" className="svg-dimension">11 foundations</text>
      ...
      <rect x="546" y="88" width="192" height="128" className="plan-power" /><text x="642" y="137" textAnchor="middle" className="svg-title svg-on-dark">BLACK-START</text><text x="642" y="161" textAnchor="middle" className="svg-label svg-on-dark">16 BIOMASS BURNERS</text><text x="642" y="187" textAnchor="middle" className="svg-note svg-on-dark">12 × 8 foundations · 1 floor</text><rect x="754" y="88" width="64" height="128" fill="url(#hazard)" stroke="#26292d" strokeWidth="2" /><text x="786" y="232" textAnchor="middle" className="svg-dimension">power edge</text>
      <rect x="64" y="334" width="448" height="116" className="plan-reserve-zone" /><text x="288" y="373" textAnchor="middle" className="svg-title">PHASE 1 COMPONENT QUARTER</text><text x="288" y="401" textAnchor="middle" className="svg-label">RESERVE ONLY · DO NOT BUILD IN PHASE 0</text><text x="288" y="427" textAnchor="middle" className="svg-note">Use the item-specific Phase 1 source and component maps</text>
      <rect x="64" y="482" width="754" height="48" className="plan-boulevard" /><text x="441" y="503" textAnchor="middle" className="svg-title svg-on-dark">TERMINAL BOULEVARD</text><text x="441" y="522" textAnchor="middle" className="svg-label svg-on-dark">3 FOUNDATIONS CLEAR</text>
      <rect x="548" y="334" width="270" height="116" className="plan-reserve-zone" /><text x="683" y="373" textAnchor="middle" className="svg-title">PHASE 1 TERMINAL FRONTAGE</text><text x="683" y="401" textAnchor="middle" className="svg-label">20 × 6 FOUNDATION RESERVE</text><text x="683" y="427" textAnchor="middle" className="svg-note">No containers or terminal building in Phase 0</text>
      ...
      <path d="M518 56v410" className="utility-spine" /><text x="532" y="302" transform="rotate(-90 532 302)" textAnchor="middle" className="svg-dimension">1 FOUNDATION UTILITY SPINE</text><path d="M683 450v32M683 530v18" className="belt-link" />
    </svg>
  </figure>;
}
